...
docker build --platform linux/arm64 --build-args ARCH=aarch64 --build-args COMPOSE_VERSION=v5.1.4 -t ghcr.io/rhoboro/docker-in-microsandbox:v5.1.4-aarch64 .
docker build --platform linux/amd64 --build-args ARCH=x86_64 --build-args COMPOSE_VERSION=v5.1.4 -t ghcr.io/rhoboro/docker-in-microsandbox:v5.1.4-x86_64 .
